...
const DestinationsScreen = ({ navigation }) => {
  ...
  /* console.log("onTheWayData", onTheWayData); */
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.tabContainer}>
        ...
        >
          <Text
            style={
              activeTab === "OnTheWay" ? styles.activeTabText : styles.tabText
            }
          >
            On The Way
          </Text>
      ...
      <Text style={styles.selectionText}>
        {selectedItems.length} destinations selected. (Select destinations)
      </Text>
